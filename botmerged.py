...
# API KEYS
# Gemini Ai API KEY
API_KEY= os.environ['AIzaSyDPzrrMUXMAJcQntXw-yZ92l6mMRWiVkAc']
# Telegram Auth API ID
API_ID = os.environ['21845506']
# Telegram Auth API HASH
API_HASH = os.environ['4bbf9dfd9e070499745f843ebf7c7cce']
# Telegram Bot API TOKEN generated from @botfather
BOT_TOKEN = os.environ['7187721092:AAF-beUsw9CL8Fcvb8FNdfRG4iUEBYzVfgQ']
